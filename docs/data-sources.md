...
| **USGS groundwater wells** | Four monitoring wells sit in/near the Linda Mar valley floor (373517122295601/-02 at 35 ft elev, 373513122293001 at 60 ft, 373512122291601 at 150 ft). Measurement history **unverified** — the old NWIS gwlevels API was decommissioned fall 2025; check via the new `api.waterdata.usgs.gov` OGC API or DWR's SGMA Data Viewer / CASGEM. Expect sparse periodic measurements at best. |
